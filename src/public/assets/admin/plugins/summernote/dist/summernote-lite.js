...
(function (global, factory) {
  ...
  var videoDialog = function (opt) {
      var body = '<div class="note-form-group">' +
          ...
          '</div>';
      var footer = [
          '<button type="button" href="javascript:void(0);" class="note-btn note-bg-primary border border-primary text-white text-center hover:bg-primary-hover hover:text-white note-video-btn disabled" disabled>',
  ...
  var imageDialog = function (opt) {
      var body = '<div class="note-form-group note-group-select-from-files">' +
          ...
          '</div>';
      var footer = [
          '<button href="javascript:void(0);" type="button" class="note-btn note-bg-primary border border-primary text-white text-center hover:bg-primary-hover hover:text-white note-btn-large note-image-btn disabled" disabled>',
      ...
      var body = '<div class="note-form-group">' +
          ...
          (!opt.disableLinkTarget
              ? '<div class="checkbox">' +
                  ...
                  '</div>' : '');
      var footer = [
          '<button href="javascript:void(0);" type="button" class="note-btn note-bg-primary border border-primary text-white text-center hover:bg-primary-hover hover:text-white note-link-btn disabled" disabled>',
  ...
  */
  ...
  var LinkDialog = /** @class */ (function () {
      ...
      LinkDialog.prototype.initialize = function () {
          ...
          var buttonClass = 'btn bg-primary border border-primary text-white text-center hover:bg-primary-hover hover:text-white note-btn note-bg-primary border border-primary text-white text-center hover:bg-primary-hover hover:text-white note-link-btn';
  ...
  var ImageDialog = /** @class */ (function () {
      ...
      ImageDialog.prototype.initialize = function () {
          ...
          var buttonClass = 'btn bg-primary border border-primary text-white text-center hover:bg-primary-hover hover:text-white note-btn note-bg-primary border border-primary text-white text-center hover:bg-primary-hover hover:text-white note-image-btn';
  ...
  var VideoDialog = /** @class */ (function () {
      ...
      VideoDialog.prototype.initialize = function () {
          ...
          var buttonClass = 'btn bg-primary border border-primary text-white text-center hover:bg-primary-hover hover:text-white note-btn note-bg-primary border border-primary text-white text-center hover:bg-primary-hover hover:text-white note-video-btn';
