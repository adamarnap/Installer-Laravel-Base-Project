        ...
        data: {
            ...
            datasets: [
                ...
                },
                {
                    label: "2023",
                    data: [250, 120, 90, 60],
                    backgroundColor: [theme("chart-primary-rgb", 0.3), theme("chart-secondary-rgb", 0.3), theme("chart-dark-rgb", 0.3), theme("chart-gray-rgb", 0.3)],
                    borderColor: "transparent",
                    borderWidth: 3,
                },
            ],
            ...
            datasets: [
                {
                    ...
                    backgroundColor: [
                        ...
                        theme("chart-delta"),
                        theme("chart-gray"),
                        theme("chart-primary-rgb", 0.5), // Add one more color for the fifth item
                    ],
                    borderColor: [
                        theme("chart-primary"),
                        theme("chart-secondary"),
                        theme("chart-delta"),
                        theme("chart-gray"),
                        theme("chart-primary-rgb", 0.1), // Match border color
                    ],
                    borderWidth: 2,
                },
            ],
