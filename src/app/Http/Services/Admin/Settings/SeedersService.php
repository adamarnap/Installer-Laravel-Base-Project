        ...
        return DataTables::of($seeders)
            ...
            ->addColumn('class_name', function ($row) {
                return '<div class="flex items-center gap-2">
                    <i class="ti ti-database-import text-primary text-base"></i>
                    <div>
            ...
            ->addColumn('aksi', function ($row) {
                ...
                return '<button type="button" class="btn-run-seeder btn bg-primary border border-primary text-white hover:bg-primary-hover py-1.5 px-3 rounded text-xs inline-flex items-center gap-1.5"
                    data-class="' . e($row['class']) . '"
                    data-name="' . e($row['class']) . '">
                    <i class="ti ti-player-play text-sm"></i> Jalankan Seeder
                </button>';
            })
