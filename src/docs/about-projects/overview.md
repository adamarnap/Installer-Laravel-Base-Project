...
|---|---|
| Badge | `resources/views/templates/template-badge.blade.php` |
| Basic Select (Choices.js) | `resources/views/templates/template-basic-select.blade.php` |
| Button | `resources/views/templates/template-button.blade.php` |
...
| Icon Badge | `resources/views/templates/template-icon-badge.blade.php` |
