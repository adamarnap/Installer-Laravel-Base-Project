        ...
        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
            <div class="trezo-card-content">
                ...
                <div class="flex items-center justify-center mx-auto text-secondary-500 bg-secondary-100 dark:bg-[#15203c] w-[77px] h-[77px] my-[15px] rounded-full">
                    <i class="material-symbols-outlined !text-3xl">
                        auto_stories
                    </i>
                </div>
                <div class="flex items-center justify-between text-sm">
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="mt-[10px]">
                            ...
                            <div class="ltr:text-right rtl:text-left">
                                <a href="course-details.html" class="inline-block rounded-md mt-[18px] px-[13px] py-[6px] text-white border border-white transition-all hover:bg-white hover:text-black">
