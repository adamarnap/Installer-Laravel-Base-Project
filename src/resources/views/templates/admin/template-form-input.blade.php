...
<div class="card bg-white border border-borderColor rounded mb-5">
    ...
    <div class="card-body p-4">
        ...
        <form action="/" method="post" class="dropzone border-2 border-dashed border-borderColor rounded min-h-[150px] p-5 cursor-pointer" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
            <div class="fallback">
                <input name="file" type="file" multiple>
            </div>
            <div class="dz-message text-center my-4 needsclick">
                <i class="ti ti-cloud-upload h1 text-muted text-[24px]"></i>
                <h3 class="my-3 text-[28px]">Drop files here or click to upload.</h3>
