    <div>
        <div id="theme-customization" class="hs-overlay hs-overlay-open:translate-x-0 bg-card hs-overlay-open:flex fixed inset-y-0 end-0 bottom-0 z-80 hidden w-full max-w-[400px] translate-x-full transform flex-col overflow-hidden transition-all duration-300 rtl:-translate-x-full">
            <div class="bg-primary text-default-600 border-default-900/10 flex items-start gap-3 border-b border-dashed bg-[url(../images/settings-bg.png)] p-6">
                ...
                <div class="grow">
                    <button type="button" data-hs-overlay="#theme-customization" class="btn btn-sm bg-default-100/20 size-7.5 rounded-full text-white">
        ...
        <div class="card-radio" id="skin-default">
            <input class="hidden" type="radio" name="data-skin" id="demo-skin-default" value="default">
            <label class="form-label" for="demo-skin-default">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-default.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-minimal">
            <input class="hidden" type="radio" name="data-skin" id="demo-skin-minimal" value="minimal">
            <label class="form-label" for="demo-skin-minimal">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-minimal.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-modern">
            <input class="hidden" type="radio" name="data-skin" id="demo-skin-modern" value="modern">
            <label class="form-label" for="demo-skin-modern">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-modern.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-material">
            <input class="hidden" type="radio" name="data-skin" id="demo-skin-material" value="material">
            <label class="form-label" for="demo-skin-material">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-material.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-saas">
            ...
            <label class="form-label" for="demo-skin-saas">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-saas.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-flat">
            ...
            <label class="form-label" for="demo-skin-flat">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-flat.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-galaxy">
            <input class="hidden" type="radio" name="data-skin" id="demo-skin-galaxy" value="galaxy">
            <label class="form-label" for="demo-skin-galaxy">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-galaxy.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-luxe">
            ...
            <label class="form-label" for="demo-skin-luxe">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-luxe.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-retro">
            ...
            <label class="form-label" for="demo-skin-retro">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-retro.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-neon">
            ...
            <label class="form-label" for="demo-skin-neon">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-neon.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-pixel">
            ...
            <label class="form-label" for="demo-skin-pixel">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-pixel.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-soft">
            ...
            <label class="form-label" for="demo-skin-soft">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-soft.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-mono">
            ...
            <label class="form-label" for="demo-skin-mono">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-mono.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-zen">
            ...
            <label class="form-label" for="demo-skin-zen">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-zen.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-silver">
            ...
            <label class="form-label" for="demo-skin-silver">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-silver.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-prism">
            ...
            <label class="form-label" for="demo-skin-prism">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-prism.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-nova">
            ...
            <label class="form-label" for="demo-skin-nova">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-nova.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-elegant">
            <input class="hidden" type="radio" name="data-skin" id="demo-skin-elegant" value="elegant">
            <label class="form-label" for="demo-skin-elegant">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-elegant.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-vivid">
            ...
            <label class="form-label" for="demo-skin-vivid">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-vivid.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-matrix">
            ...
            <label class="form-label" for="demo-skin-matrix">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-matrix.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-neo">
            ...
            <label class="form-label" for="demo-skin-neo">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-neo.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-xenon">
            ...
            <label class="form-label" for="demo-skin-xenon">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-xenon.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-crystal">
            ...
            <label class="form-label" for="demo-skin-crystal">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-crystal.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-aurora">
            ...
            <label class="form-label" for="demo-skin-aurora">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-aurora.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
        ...
        <div class="card-radio" id="skin-orbit">
            ...
            <label class="form-label" for="demo-skin-orbit">
                <img src="{{ URL::asset('assets/admin/images/layouts/skin-orbit.png') }}" alt="layout-img" class="flex size-full rounded-md">
            </label>
                        ...
                        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-base">
                            <div class="card-radio">
                                ...
                                <label class="form-label" for="direction-ltr">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/theme-light.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                            ...
                            <div class="card-radio">
                                ...
                                <label class="form-label" for="direction-rtl">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/theme-light.png') }}" alt="layout img" class="flex size-full scale-x-[-1] rounded-md">
                                </label>
                        ...
                        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-base">
                            <div class="card-radio" id="sidenav-size-default">
                                ...
                                <label class="form-label" for="sidenav-view-default">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/sidenav-size-default.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                                <h5 class="text-md text-default-600 mt-2.5 text-center">Default</h5>
                            </div>

                            <div class="card-radio" id="sidenav-size-compact">
                                <input class="hidden" type="radio" name="data-sidenav-size" id="sidenav-view-compact" value="compact">
                                <label class="form-label" for="sidenav-view-compact">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/sidenav-size-compact.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                                <h5 class="text-md text-default-600 mt-2.5 text-center">Compact</h5>
                            </div>

                            <div class="card-radio" id="sidenav-size-condensed">
                                <input class="hidden" type="radio" name="data-sidenav-size" id="sidenav-view-condensed" value="condensed">
                                <label class="form-label" for="sidenav-view-condensed">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/sidenav-size-condensed.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                                <h5 class="text-md text-default-600 mt-2.5 text-center">Condensed</h5>
                            </div>

                            <div class="card-radio" id="sidenav-size-on-hover">
                                <input class="hidden" type="radio" name="data-sidenav-size" id="sidenav-view-hover" value="on-hover">
                            ...
                            <div class="card-radio" id="sidenav-size-on-hover-active">
                                <input class="hidden" type="radio" name="data-sidenav-size" id="sidenav-view-hover-active" value="on-hover-active">
                            ...
                            <div class="card-radio" id="sidenav-size-offcanvas">
                                ...
                                <label class="form-label" for="sidenav-view-mobile">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/sidenav-size-offcanvas.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                        ...
                        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-base">
                            ...
                            <div class="card-radio" id="theme-dark">
                                ...
                                <label class="form-label" for="layout-color-dark">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/theme-dark.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                            ...
                            <div class="card-radio" id="theme-system">
                                ...
                                <label class="form-label" for="layout-color-system">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/theme-system.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                    ...
                    <div id="sidenav-color" class="p-5">
                        ...
                        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-base">
                            <div class="card-radio" id="sidenav-color-light">
                                <input class="hidden" type="radio" name="data-menu-color" id="menu-color-light" value="light">
                                <label class="form-label" for="menu-color-light">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/sidenav-color-light.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                                <h5 class="text-md text-default-600 mt-2.5 text-center">Light</h5>
                            </div>

                            <div class="card-radio" id="sidenav-color-dark">
                                <input class="hidden" type="radio" name="data-menu-color" id="menu-color-dark" value="dark">
                                <label class="form-label" for="menu-color-dark">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/sidenav-color-dark.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                                <h5 class="text-md text-default-600 mt-2.5 text-center">Dark</h5>
                            </div>

                            <div class="card-radio" id="sidenav-color-gradient">
                                <input class="hidden" type="radio" name="data-menu-color" id="menu-color-gradient" value="gradient">
                                <label class="form-label" for="menu-color-gradient">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/sidenav-color-gradient.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                                <h5 class="text-md text-default-600 mt-2.5 text-center">Gradient</h5>
                            </div>

                            <div class="card-radio" id="sidenav-color-gray">
                                <input class="hidden" type="radio" name="data-menu-color" id="menu-color-gray" value="gray">
                                <label class="form-label" for="menu-color-gray">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/sidenav-color-gray.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                                <h5 class="text-md text-default-600 mt-2.5 text-center">Gray</h5>
                            </div>

                            <div class="card-radio" id="sidenav-color-image">
                                <input class="hidden" type="radio" name="data-menu-color" id="menu-color-image" value="image">
                                <label class="form-label" for="menu-color-image">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/sidenav-color-image.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                    ...
                    <div id="topbar-color" class="p-5">
                        ...
                        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-base">
                            <div class="card-radio" id="topbar-color-light">
                                <input class="hidden" type="radio" name="data-topbar-color" id="layout-topbar-color-light" value="light">
                                <label class="form-label" for="layout-topbar-color-light">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/topbar-color-light.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                                <h5 class="text-md text-default-600 mt-2.5 text-center">Light</h5>
                            </div>

                            <div class="card-radio" id="topbar-color-dark">
                                <input class="hidden" type="radio" name="data-topbar-color" id="layout-topbar-color-dark" value="dark">
                                <label class="form-label" for="layout-topbar-color-dark">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/topbar-color-dark.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                                <h5 class="text-md text-default-600 mt-2.5 text-center">Dark</h5>
                            </div>

                            <div class="card-radio" id="topbar-color-gradient">
                                <input class="hidden" type="radio" name="data-topbar-color" id="layout-topbar-color-gradient" value="gradient">
                                <label class="form-label" for="layout-topbar-color-gradient">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/topbar-color-gradient.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                                <h5 class="text-md text-default-600 mt-2.5 text-center">Gradient</h5>
                            </div>

                            <div class="card-radio" id="topbar-color-gray">
                                <input class="hidden" type="radio" name="data-topbar-color" id="layout-topbar-color-gray" value="gray">
                                <label class="form-label" for="layout-topbar-color-gray">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/topbar-color-gray.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                                <h5 class="text-md text-default-600 mt-2.5 text-center">Gray</h5>
                            </div>
                        </div>
                    ...
                    <div id="width" class="p-5">
                        ...
                        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-base">
                            <div class="card-radio" id="width-fluid">
                                <input class="hidden" type="radio" name="data-layout-width" id="layout-width-fluid" value="fluid">
                                <label class="form-label" for="layout-width-fluid">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/width-fluid.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                                <h5 class="text-md text-default-600 mt-2.5 text-center">Fluid</h5>
                            </div>

                            <div class="card-radio" id="width-boxed">
                                <input class="hidden" type="radio" name="data-layout-width" id="layout-width-boxed" value="boxed">
                                <label class="form-label" for="layout-width-boxed">
                                    <img src="{{ URL::asset('assets/admin/images/layouts/width-boxed.png') }}" alt="layout img" class="flex size-full rounded-md">
                                </label>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex gap-1">
                                <div id="position-fixed">
                                    <input type="radio" class="peer hidden" name="data-layout-position" id="layout-position-fixed" value="fixed">
                                ...
                                <div id="position-scrollable">
                                    <input type="radio" class="peer hidden" name="data-layout-position" id="layout-position-scrollable" value="scrollable">
            ...
            <div class="border-default-900/10 flex border-t p-5">
                <div class="grid w-full grid-cols-2 gap-4">
                    <a href="https://1.envato.market/paces" class="btn py-3 w-full bg-success hover:bg-success-hover text-white">
                        <i class="iconify tabler--basket"></i> Buy Now
                    </a>
                    <button type="button" class="btn py-3 w-full bg-danger text-white hover:bg-danger-hover" id="reset-layout">
