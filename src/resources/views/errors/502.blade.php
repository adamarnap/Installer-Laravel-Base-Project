...
@section('content')
    <div class="max-w-[960px] mx-auto text-center px-4">
        ...
        <p class="text-gray-600 dark:text-gray-300 mb-[30px] !text-[16px] md:!text-[18px]">
            The server received an invalid response from the upstream server. Please try again in a few moments.
        </p>
        ...
        <a href="{{ route('beranda.index') }}" class="inline-block font-medium rounded-md text-[16px] md:text-[18px] py-[12px] px-[25px] text-gray-700 bg-gray-200 hover:bg-gray-300 dark:text-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 transition-all">
            Back to Home
        </a>
    </div>
@endsection